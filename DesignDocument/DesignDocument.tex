...
\begin{itemize}
  \item Selection rules: random rule, balance rule, goodwill rule etc.
  \item Parameters: Time, N people, M products, value of products etc. 
\end{itemize}

\textbf{Output}

\begin{itemize}
  \item Results: Community effect, number of transactions etc.
  \item Graphs, functions that show the results over time etc.
\end{itemize}

\subsection{Rules for the simulator}
...
\section{3. Back-end}
\textit{Packages: Numpy, }
\\
I made the following design choices for the course of the giving game.
\begin{itemize}
  \item The player will be a node in a peer-to-peer network where every node keeps track of its saldo with the other nodes. To accomplish this I will be using a object oriented structure to create this network.
  \item For the calculations of the saldo and other variables I will make use of the numpy package.
\end{itemize}
...
\textit{Packages: Numpy, matplotlib, pychart}
\\
